  ...
  return (
    <section className="bg-gray-500 max-w-full text-white py-10 px-6">
      ...
      <div className="relative w-full max-w-6xl mx-auto overflow-hidden">
        ...
        <div className="relative h-64 sm:h-80 md:h-[500px] lg:h-[600px] rounded-lg">
        ...
        <button
          onClick={prevSlide}
          className="absolute top-1/2 -left-6 transform ml-4 sm:ml-10 -translate-y-1/2 bg-red-800 hover:text-red-800 hover:bg-white/40 text-white rounded-full p-2"
        >
          <svg
            className="w-6 h-6"
            fill="none"
        ...
        <button
          onClick={nextSlide}
          className="absolute top-1/2 -right-6 transform mr-4 sm:mr-10 -translate-y-1/2 bg-red-800 hover:bg-white/40 hover:text-red-800 text-white rounded-full p-2"
        >
          <svg
            className="w-6 h-6"
            fill="none"
